...
def save_entry():
    ...
    with open("C:/Users/Adit Kadiyan/Downloads/class-136-1-4-Digi-Dairy-main/class-136-1-4-Digi-Dairy-main/static/assets/data_files/tweet_emotions.csv", "a") as f:
        f.write(entry)
